        ...
        if (request.status === 200){
            ...
            response.forEach(element => {
                if (element.complete == true){
                    ...
                    if (element.time == null){
                        taskbox[0].innerHTML += `    <div class="task-wrapper" data-position="{{task.pk}}">
                        <div class="task-title">
                            <div class=" edit-icon" data-id=${element.id} data-action="edit">${element.priority === 'Priority 1' ? '&#128681;' : element.priority === 'Priority 2' ? '&#127988;' : '&#x2690;'  }</div>
                        ...
                        <div class="task-controls">
                            <a class="delete-link edit-icon" data-id=${element.id} data-action="delete">&#215;</a>
                            <a href="#"><span class="handle countdown" data-id=${element.id}  data-name="${element.name}" data-time=${element.time}>&#128336;</span></a>
                        </div>
                    </div>`
                    }
                }
            ...
            for(i=0;i<countdown_icon.length;i++){
                countdown_icon[i].addEventListener('click',function(){
                    ...
                    location.replace('taskcountdown.html')
                })
            }
